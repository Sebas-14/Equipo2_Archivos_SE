...
#define tam_sig 90  //tamaño de la señal de entrada
...
void SNR(){//metodo snr
  int i;//variable
  for(i=0;i<90;i++){//ciclo reccorre segun el numero de datos de la señal
    promOri=promOri+flex_sensor[i];//guarda los valores del promedio en cada punto 
    }
   double promOri1 = promOri/90;//lo divide para el numero de datos de la señal
   for(i=0;i<90;i++){//reccorrico del numero de datos de la señal filtrada
    promFilt=promFilt+output[i];
    }
   double promFilt2 = promFilt/90;//lo divide para el numero de datos de la señal filtrada
